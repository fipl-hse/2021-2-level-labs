...
if __name__ == '__main__':
    ...
    text_tokens = main.tokenize_by_letters(text)
    text_storage = main.LetterStorage()
    ...
    # 6
    encoded_text = main.encode_corpus(text_storage, text_tokens)
    text_profile = main.LanguageProfile(text_storage, "en")
    text_profile.create_from_tokens(encoded_text, (2,))
    text_generator = main.NGramTextGenerator(text_profile)
