...
print('compare_profiles:', compare_profiles(unk_profile, en_profile, 10))
print('detect_language:', detect_language(unk_profile, de_profile, en_profile, 10))
print('compare_profiles_advanced:', compare_profiles_advanced(unk_profile, en_profile, 10))
profiles = [de_profile, la_profile, en_profile]
print('detect_languages_advanced:', detect_language_advanced(unk_profile, profiles, [], 10))
