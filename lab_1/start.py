...
if __name__ == '__main__':
    ...
    with open(os.path.join(PATH_TO_TEXTS_FOLDER, 'en.txt'), 'r', encoding='utf-8') as ftr_en:
        en_text = ftr_en.read()

    with open(os.path.join(PATH_TO_TEXTS_FOLDER, 'de.txt'), 'r', encoding='utf-8') as ftr_de:
        de_text = ftr_de.read()

    with open(os.path.join(PATH_TO_TEXTS_FOLDER, 'la.txt'), 'r', encoding='utf-8') as ftr_la:
        la_text = ftr_la.read()
