...
if __name__ == '__main__':
    ...
    unknown_enc = lab_3.main.encode_corpus(storage, tokenize_unknown_sample)
    ...
    unknown_profile.create_from_tokens(unknown_enc, (2,))
    eng_profile.create_from_tokens(eng_enc, (2,))
    de_profile.create_from_tokens(de_enc, (2,))

    distance_unknown_eng = lab_3.main.calculate_distance(unknown_profile, eng_profile, 5, 2)
    distance_unknown_de = lab_3.main.calculate_distance(unknown_profile, de_profile, 5, 2)

    print(distance_unknown_eng)
    print(distance_unknown_de)
    ...
    RESULT = distance_unknown_eng, distance_unknown_de
