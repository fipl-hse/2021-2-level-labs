...
class LetterStorageTest(unittest.TestCase):
    ...
    def test_letter_storage_put_letter_existing(self):
        ...
        storage = letter_storage.storage
        expected = 0
        actual_exit_code = letter_storage._put_letter(letter)
        self.assertEqual(letter_storage.storage, storage)
