...
import os
from lab_2.main import tokenize, remove_stop_words, get_language_profiles, get_text_vector, predict_language_score
...
if __name__ == '__main__':
    ...
    for text in UNKNOWN_SAMPLES:
        ...
        predict_language = predict_language_score(unknown_text_vector, known_text_vectors, language_labels)

    RESULT.append(predict_language)
