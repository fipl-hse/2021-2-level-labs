...
|03.12.2021| Инкапсуляция, наследование атрибутов через метод super(). | Работа с классами, практика создания классов родителей и наследников. [Листинг кода](./seminars/12.3.2021/practice_10.py) |
|10.12.2021| Полиморфизм: мотивация, концепция, реализация. | Работа с классами, практика создание полиморфных классов. [Листинг кода](./seminars/12.10.2021/practice_11.py) |
