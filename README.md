...
|12.11.2021| Введение в ООП: общая мотивация, классы, метод `__init__`. | [Листинг кода](./seminars/11.12.2021/practice_8.py) |
|19.11.2021| Инкапсуляция, метод `__str__`. | [Листинг кода](./seminars/11.19.2021/practice_9.py) |
